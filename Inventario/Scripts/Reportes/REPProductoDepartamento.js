$(document).ready(function () {
    ...
    function GetDepartamentos() {
        return new Promise((resolve, reject) => {
            $.ajax({
                type: 'GET',
                url: '/REPProductoDepartamento/GetDepartamentos',
    ...
    function GenerarReporte(departamento) {
        var datasourcereporte = new DevExpress.data.CustomStore({
            load: function (loadOptions) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/REPProductoDepartamento/GenerarReporte',
                    contentType: "application/json; charset=utf-8",
                    dataType: 'json',
                    data: { departamento },
                    cache: false,
        ...
        var PivotGrid = $("#gridContainer").dxDataGrid({
            ...
            export: {
                enabled: true,
                fileName: 'REPORTE DE ARTICULOS POR DEPARTAMENTO'
            },
            onExporting: function (e) {
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    headerRow.getCell(1).value = 'REPORTE DE ARTICULOS POR DEPARTAMENTO';
                    ...
                    workbook.xlsx.writeBuffer().then(function (buffer) {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'REPORTE_ARTICULOSPORDEPARTAMENTO.xlsx');
                    });
                });
                e.cancel = true;
            }
