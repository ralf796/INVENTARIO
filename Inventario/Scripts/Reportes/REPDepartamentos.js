    ...
    function GenerarReporte(nombre) {
        var datasourcereporte = new DevExpress.data.CustomStore({
            load: function (loadOptions) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/REPDepartamentos/GenerarReporte',
        ...
        var PivotGrid = $("#gridContainer").dxDataGrid({
            ...
            onExporting: function (e) {
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    headerRow.getCell(1).value = 'REPORTE DE DEPARTAMENTOS';
                    ...
                    workbook.xlsx.writeBuffer().then(function (buffer) {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'REPORTE_DEPARTAMENTOS.xlsx');
                    });
                });
                e.cancel = true;
            }
