$(document).ready(function () {
    ...
    function Procesar(pDatos, controller) {
        ...
        $.ajax({
            type: 'POST',
            url: '/CATCrearCategoria/' + controller,
            data: {
    ...
    function TBL_CATEGORIA(ID_CATEGORIA, NOMBRE) {
    ...
    $('#btnGuardar').on('click', function (e) {
        ...
        var DATOS = new TBL_CATEGORIA(idTipoMenu, nombre);
    ...
    function Inactivar(id) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/CATCrearCategoria/Eliminar',
                    data: {
                        id: id
                    },
                    success: function (data) {
    ...
    function llenarReporte() {
        var customStore = new DevExpress.data.CustomStore({
            load: function (loadOptions) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/CATCrearCategoria/CargarTablaTipoMenu',
                    ...
                    buttons: [
                        {
                            ...
                            icon: "edit",
                            onClick: function (e) {
                                $('#hfIDTIPOMENU').val(e.row.data['ID_CATEGORIA']);
                        ...
                        },
                        {
                            ...
                            icon: "close",
                            onClick: function (e) {
                                Inactivar(e.row.data['ID_CATEGORIA']);
                            }
                        }
                    ]
                }
